...
import com.patchwork.library.model.Book.BookType
    ...
    fun findByTitle(title: String): List<BookAvailability> {
     ...
     fun borrowBook(borrowBook: BorrowBook): PersonBook {
        ...
        if book.bookType == BookType.REFERENCE {
            throw BookNotAvailableException("The book can not be borrowed it is only for reference purposes $borrowBook.isbn")
        }
